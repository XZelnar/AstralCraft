...
public class YC_WorldChunkManagerAstral extends WorldChunkManager
{
    ...
    public YC_WorldChunkManagerAstral(BiomeGenBase par1BiomeGenBase, float par2, float par3)
    {
