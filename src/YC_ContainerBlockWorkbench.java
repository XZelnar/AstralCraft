...
public class YC_ContainerBlockWorkbench extends Container
{
    private IInventory playerInventory;
    private YC_TileEntityBlockWorkbench entityInventory;
    //private int numRows;

    public YC_ContainerBlockWorkbench(InventoryPlayer par1IInventory, IInventory par2IInventory)
    {
        this.playerInventory = par1IInventory;
        entityInventory = (YC_TileEntityBlockWorkbench) par2IInventory;
        entityInventory.openChest();
        ...
        for (var4 = 0; var4 < 3; ++var4)
        {
            ...
            {
                this.addSlotToContainer(new Slot(par2IInventory, 3+var5+var4*5, 18+var5*18, 35+var4*18));
            }
        }

        for (var5 = 0; var5 < 3; ++var5)
        {
            this.addSlotToContainer(new Slot(par2IInventory, 18+var5, 36+var5*18, 89));
        }
        //fuel+output
        this.addSlotToContainer(new Slot(par2IInventory, 22, 142, 16));
        ...
        {
            this.addSlotToContainer(new Slot(par1IInventory, var4, 20 + var4 * 18, 178));
        }
        ...
        for (var4 = 0; var4 < 3; ++var4)
        {
            ...
            {
                this.addSlotToContainer(new Slot(par1IInventory, var5 + var4 * 9 + 9, 20 + var5 * 18, var4 * 18 + 120));
            }
        }
    }
