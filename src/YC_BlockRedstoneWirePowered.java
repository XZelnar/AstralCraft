...
public class YC_BlockRedstoneWirePowered extends Block
{
	/**
    ...
    public YC_BlockRedstoneWirePowered(int par1)
    {
    ...
    {
        return par0Str == "redstoneDust_cross" ? field_94413_c : (par0Str == "redstoneDust_line" ? field_94410_cO : (par0Str == "redstoneDust_cross_overlay" ? field_94411_cP : (par0Str == "redstoneDust_line_overlay" ? field_94412_cQ : null)));
    }
    ...
    public void updateTick(World par1World, int par2, int par3, int par4,
    	...
    	if (md == 1)
    	{
    		par1World.setBlockAndMetadataWithNotify(par2, par3, par4, Block.redstoneWire.blockID, 0, 0);
    	}
    	else
    	{
    		if (md == 0)
