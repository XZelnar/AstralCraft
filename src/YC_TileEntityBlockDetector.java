...
public class YC_TileEntityBlockDetector extends TileEntity implements IInventory
{
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        //this._Type = par1NBTTagCompound.getInteger("Type");
    }
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        //par1NBTTagCompound.setInteger("Type", this._Type);
	...
	public void handlePacketData(int[] intData) {
        YC_TileEntityBlockDetector chest = this;
        if (intData != null) {
          for(int i = 0; i<9; i++)
          {
        	  if (intData[i*3]!=-1)
