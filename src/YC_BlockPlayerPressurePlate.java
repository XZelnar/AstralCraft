...
public class YC_BlockPlayerPressurePlate extends Block
{
    /** The mob type that can trigger this pressure plate. */
    private EnumMobType triggerMobType;

    protected YC_BlockPlayerPressurePlate(int par1, EnumMobType par3EnumMobType, Material par4Material)
    {
        ...
        float var5 = 0.0625F;
        setUnlocalizedName("YC_Pressure plate");
    ...
    private void setStateIfMobInteractsWithPlate(World par1World, int par2, int par3, int par4)
    {
        ...
        if (var6 && !var5)
        {
            ...
            YC_CommonProxy.MarkBlockForGlobalRenderUpdate(par2, par3, par4);
    ...
    public int isProvidingStrongPower(IBlockAccess par1iBlockAccess,
        ...
        return par1iBlockAccess.getBlockMetadata(par2, par3, par4) == 0 ? 0 : par5 == 1 ? 15 : 0;
    }
