...
public class YC_ContainerBlockDetector extends Container
{
    private IInventory playerInventory;
    private IInventory entityInventory;
    private int numRows;

    public YC_ContainerBlockDetector(IInventory par1IInventory, IInventory par2IInventory)
    {
        ...
        for (var4 = 0; var4 < this.numRows; ++var4)
        {
            ...
            {
                this.addSlotToContainer(new Slot(par2IInventory, var5+var4*3, 26+var5*18, 17+var4*18));
            }
        }

        for (var4 = 0; var4 < 9; ++var4)
        {
            this.addSlotToContainer(new Slot(par1IInventory, var4, 8 + var4 * 18, 142));
        }
        ...
        for (var4 = 0; var4 < 3; ++var4)
        {
            ...
            {
                this.addSlotToContainer(new Slot(par1IInventory, var5 + var4 * 9 + 9, 8 + var5 * 18, var4 * 18 + 84));
            }
        }
    }
