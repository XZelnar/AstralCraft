...
public class YC_EntityRenderGravityExplosionGrenade extends Render
{
    private int itemIconIndex;

    public YC_EntityRenderGravityExplosionGrenade(int par1)
    {
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        this.loadTexture("/YC/particles.png");
