...
public class YC_TileEntityWorkbenchRenderer implements
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID,
        ...
        GL11.glBindTexture(GL11.GL_TEXTURE_2D, Minecraft.getMinecraft().renderEngine.getTexture("/YC/workbench.png"));
		YC_Mod.m_Workbench.Draw(0,0,1);
		GL11.glColor3f(1f, 1f, 1f);
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z,
		...
		YC_Mod.m_Workbench.Draw(Minecraft.getMinecraft().renderEngine.getTexture("/YC/workbench.png"),x,y,z+1);
