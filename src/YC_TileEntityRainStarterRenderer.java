...
public class YC_TileEntityRainStarterRenderer implements
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z,
		...
		YC_TileEntityBlockRainStarter te = (YC_TileEntityBlockRainStarter) world.getBlockTileEntity(x, y, z);
		...
		if (te.CurState<=100)
		{
			...
			YC_Mod.m_Sphere.DrawWOTranslation(color,color,1);
		...
		else
		{
			...
			GL11.glColor4f(0.25f+((float)r.nextInt(100))/10000f, 0.2f+((float)r.nextInt(100))/10000f, 1f, 
	...
	public int getRenderId() {
		return YC_Mod.c_rainStarterRenderID;
	}
}
