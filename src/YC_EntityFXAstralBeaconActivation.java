...
public class YC_EntityFXAstralBeaconActivation extends EntityFX
{
    ...
    public YC_EntityFXAstralBeaconActivation(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        this(par1World, par2, par4, par6, par8, par10, par12, 2.0F);
    }

    public YC_EntityFXAstralBeaconActivation(World par1World, double par2, double par4, double par6, double par8, double par10, double par12, float par14)
    {
    ...
    public void DrawLines(float par2, float par3, float par4, float par5, float par6, float par7)
    {
    	...
    	//float   x=var13 - par3 * var12 - par6 * var12,
    	//		y=var14 - par4 * var12,
    	//		z=var15 - par5 * var12 - par7 * var12;
        //GL11.glBindTexture(GL11.GL_TEXTURE_2D, Minecraft.getMinecraft().renderEngine.getTexture("/particles.png"));
    	...
    	//Tessellator.instance.setTranslation(Tessellator.instance.xOffset+x, Tessellator.instance.yOffset+y, 
    	//		Tessellator.instance.zOffset + z);
    	double x = Tessellator.instance.xOffset, y = Tessellator.instance.yOffset, z = Tessellator.instance.zOffset;
    	...
    	{/*
        	GL11.glColor4f(0.8f,1f,0.8f,linesAlpha[i/3]);
    		GL11.glVertex3f(lines[i], lines[i+1], lines[i+2]);
        	GL11.glColor4f(0.8f,1f,0.8f,linesAlpha[i/3+1]);
    		GL11.glVertex3f(lines[i+3], lines[i+4], lines[i+5]);*/
    		Tessellator.instance.setColorRGBA_F(0.8f,1f,0.8f,linesAlpha[i/3]);
    		...
    		Tessellator.instance.setColorRGBA_F(0.8f,1f,0.8f,linesAlpha[i/3+1]);
    ...
    public void renderParticle(float par2, float par3, float par4, float par5, float par6, float par7)
    {
        ...
        Tessellator.instance.startDrawingQuads();
        Tessellator.instance.setBrightness(0x00F0);
		Tessellator.instance.setColorRGBA_F(1f, 1f, 1f, r.nextFloat()/4f+0.75f);
