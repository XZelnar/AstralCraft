...
public class YC_BlockRainStarter extends Block
{
    public YC_BlockRainStarter(int par1)
    {
	...
	public TileEntity createTileEntity(World world, int metadata) {
		YC_TileEntityBlockRainStarter te = new YC_TileEntityBlockRainStarter();
		return te;
	}
	
	@Override
	public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4) {
		if (!par1World.isRaining() && par1World.canBlockSeeTheSky(par2, par3, par4))
		{
