...
public class YC_EntityFXEnergyFromAirGaining extends EntityFX
{
    ...
    public YC_EntityFXEnergyFromAirGaining(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        this(par1World, par2, par4, par6, par8, par10, par12, 2.0F);
    }

    public YC_EntityFXEnergyFromAirGaining(World par1World, double par2, double par4, double par6, double par8, double par10, double par12, float par14)
    {
